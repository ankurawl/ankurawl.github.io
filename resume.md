...
- **Strategy**: Redefined platform strategy to focus on scalability and reuse of user research insights vs tooling development, thus enabling researchers to discover and build upon past findings instead of running duplicate surveys.
...
- **Reduced cost by 20%+** by automating interview management, cutting effort for recruiters, schedulers, and interviewers.
...
- **Seller Lending (0-to-1)**: Partnered with Goldman Sachs to launch third-party lending on a multi-billion dollar portfolio, **driving 20%+ growth** in book size. Merged first-party and third-party products to reduce balance sheet risk.
- **Prime**: Grew **paid members by 100%** over 2 years for Amazon's flagship subscription program; launched referral and event channels, added Prime Video benefit, increased student sign-ups from **4% to 8%** of visitors via ML-based verification.
...
- **Logitech**: Launched universal remote that doubled daily active usage and cut setup time from 10+ min to 5 min.
...
- **Autonomous Content Agent**: Multi-step agent that creates product management content and publishes to X with human-in-the-loop approval.
- **Interview Feedback Agent**: Built and deployed to Meta's internal agent system for structured interview feedback writing.

---

## Community Leadership

- **Akshaya Patra (Food for Education)**: Grew annual fundraising from **$100K to $400K+** over 5 years (2018--2023), a **4X increase** in program funding.

---

## Education

- **Certificate**: Google Advanced Data Analytics with Machine Learning, Feb--Aug 2024
